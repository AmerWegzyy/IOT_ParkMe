...
constexpr uint32_t PARKME_SENSOR_HEARTBEAT_INTERVAL_MS = 120000;
constexpr uint32_t PARKME_SENSOR_WIFI_RETRY_INTERVAL_MS = 10000;
constexpr uint32_t PARKME_SENSOR_HTTP_TIMEOUT_MS = 5000;
constexpr bool PARKME_SENSOR_ALLOW_FREE_HEARTBEATS = false;

constexpr uint32_t PARKME_GATE_SPOT_ID = 201;
constexpr int8_t PARKME_GATE_BUTTON_PIN = 13;
